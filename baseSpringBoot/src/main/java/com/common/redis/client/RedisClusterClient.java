 ...
 * redis集群
 * @author jianghaoming
 * @date 2019-07-23 17:53:45
 */
@Component("RedisClusterClient")
public class RedisClusterClient extends BaseRedisClientImpl implements BaseRedisClient{
	...
	private static synchronized void initRedis(){
        ...
        list.forEach( str ->{
            ...
            nodeList.add(makeRedisURI(strs[0], Integer.parseInt(strs[1]), passwd));
        });
        io.lettuce.core.cluster.RedisClusterClient lettuceRedis = io.lettuce.core.cluster.RedisClusterClient.create(nodeList);
        pool = ConnectionPoolSupport.createGenericObjectPool(lettuceRedis::connect, getPoolConfig());
	}
     ...
     * 异步
     */
    public RedisAdvancedClusterAsyncCommands<String, String> getAsyncCommand(){
     ...
     * 同步
     */
    public RedisAdvancedClusterCommands<String, String> getCommand(){
